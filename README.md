...
[![Version](https://img.shields.io/badge/version-1.11.0-blue)](docs/v1.11.0.md)
[![License](https://img.shields.io/badge/license-MIT-green)](LICENSE)

[快速开始](#install) · [看示例](#see-it-work) · [脚本开发](#脚本开发) · [版本说明](docs/v1.11.0.md) · [更新日志](docs/CHANGELOG.md)
...
| 文档 | 内容 |
|------|------|
| [v1.11.0 版本说明](docs/v1.11.0.md) | 当前版本：功能弹窗、UI 优化 |
